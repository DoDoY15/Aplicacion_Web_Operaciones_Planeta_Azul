  ...
  return (
    <div className="max-w-2xl space-y-5 animate-fade-in">
      <div className="flex items-center gap-3">
        ...
        <h1 className="font-display text-xl font-bold text-[#E8EEF4]">Novo Item</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="card card-accent p-6 space-y-5">
        <div>
          ...
          <input value={title} onChange={e => setTitle(e.target.value)}
            placeholder="Descreva o item em poucas palavras..."
        ...
        <div>
          ...
          <textarea value={description} onChange={e => setDescription(e.target.value)}
            placeholder="Contexto, detalhes, critérios de conclusão..."
            rows={4}
        ...
        <label className="flex items-center gap-3 cursor-pointer group">
          ...
          <span className="text-sm text-[#7D95A8]">Requer aprovação antes de iniciar</span>
        </label>
